...
void DX8Wrapper::Apply_Default_State() {
  ...
  for (i = 0; i < CurrentCaps->Get_Max_Textures_Per_Pass(); i++) {
    ...
    //D3DTEXF_LINEAR); 		Set_DX8_Texture_Stage_State(i, D3DTSS_MINFILTER,
    //D3DTEXF_LINEAR); 		Set_DX8_Texture_Stage_State(i, D3DTSS_MIPFILTER,
    //D3DTEXF_LINEAR); 		Set_DX8_Texture_Stage_State(i, D3DTSS_MIPMAPLODBIAS, 0);
