...
- **Частицы/объёмные эффекты** — дым, прожекторы рендерятся как белые квадраты. Текстуры привязаны но alpha blending не обрезает границы billboard quad. Проблема в рендер-пайплайне, не в стабах
