...
#define PRESERVE_NO_XP_FROM_POISON_KILLS (1) // TheSuperHackers @test Temporarily restored to the pre-#3065 value to isolate the DET desync.
#endif

#ifndef PRESERVE_OCCUPANT_DETECTION_VIA_DRAG_SELECTION
#define PRESERVE_OCCUPANT_DETECTION_VIA_DRAG_SELECTION (1) // TheSuperHackers @test Temporarily restored to the pre-#3065 value to isolate the DET desync.
#endif
...
#define PRESERVE_PREMATURE_BATTLE_BUS_DEATH (1) // TheSuperHackers @test Temporarily restored to the pre-#3065 value to isolate the DET desync.
#endif
